  ...
  // ============================================================================
  {
    ...
    lessons: [
      L(1, 'Activity', '90-Day Culture Leadership Plan',
        ...
        '#/culture-leadership-plan-template'),
      L(2, 'Activity', 'Create Simple, Visual Standards for Each Station',
        ...
        'https://docs.google.com/document/u/0/?ftv=1&folder=0AKrj_g6DBCGdUk9PVA'),
      L(3, 'Activity', 'Implement Team Huddles During Shifts',
        ...
        'https://docs.google.com/spreadsheets/u/0/?ftv=1&folder=0AKrj_g6DBCGdUk9PVA'),
      ...
      L(5, 'Activity', 'Conduct Daily Pre-Shift Meetings with Clear Goals',
        ...
        'https://www.7shifts.com/blog/pre-shift-meeting-checklist/'),
      L(6, 'Activity', 'Create Cross-Training Opportunities',
        ...
        'https://m365.cloud.microsoft/create?fromcode=cmm6iw1gxpp&source=create_flow'),
      ...
      L(11, 'Activity', 'Train Team Leaders on Expectation Setting',
        ...
        'https://www.youtube.com/results?search_query=john+maxwell+5+levels+leadership'),
      L(12, 'Reading', 'The Culture Map - Understanding Team Dynamics',
        ...
        'https://catalog.on.worldcat.org/discovery'),
      ...
      L(16, 'Activity', 'Reward Culture Champions Publicly',
        ...
        'https://podcasts.apple.com/us/podcast/culture-by-design/id1437677615'),
      ...
      L(18, 'Activity', 'Integrate Culture into Hiring and Training',
        ...
        'https://www.cultureamp.com/blog/culture-interview-questions'),
      L(19, 'Reading', 'The Five Dysfunctions of a Team - Building Cohesion',
        ...
        'https://open.spotify.com/search/five%20dysfunctions%20team%20lencioni'),
    ],
  },

  // ============================================================================
  // Team Development Expert — 14 lessons focused on coaching, feedback,
  // development plans, succession, and high-performer growth.
  // ============================================================================
  {
    key: 'team-development-expert',
    name: 'Team Development Expert',
    tagline: 'Coach, develop, and grow every team member',
    description:
      'A 14-lesson plan for becoming the leader who actually grows people: structured one-on-ones, '
      + 'SBI feedback, personalized development plans, coaching habits, succession planning, and '
      + 'data-backed progress tracking.',
    category: 'Director Track',
    icon: '🌱',
    accent: 'emerald',
    estimated_hours: null,
    lessons: [
      L(1, 'Activity', 'Conduct Regular One-on-One Performance Discussions',
        '4 meetings + 30 minutes documentation',
        'Use the free one-on-one meeting template from Notion.so to conduct regular performance discussions that focus on growth and development.\n\n📝 **Completion Requirement:** Complete 4 one-on-one performance discussions, documenting key topics discussed and follow-up actions.',
        'https://www.notion.com/templates/one-on-one-meeting-template'),
      L(2, 'Activity', 'Provide Specific, Behavior-Focused Feedback',
        '1 week of practice + 25 minutes documentation',
        'Practice giving specific, behavior-focused feedback using the SBI model (Situation-Behavior-Impact) rather than personality traits.\n\n📝 **Completion Requirement:** Document 5 feedback conversations, including the specific situation, behavior observed, and impact discussed.'),
      L(3, 'Activity', 'Create Personalized Development Plans for Each Team Member',
        '3 hours',
        "Use the free development plan template from Microsoft Word online to create individualized development plans aligned with each team member's strengths, interests, and career goals.\n\n📝 **Completion Requirement:** Create development plans for 5 team members, including specific skills to develop, learning resources, and timeline.",
        'http://m365.cloud.microsoft/create?fromcode=cmm6iw1gxpp&source=create_flow'),
      L(4, 'Activity', 'Set SMART Goals with Team Members',
        '2 hours',
        'Use the free SMART goals worksheet from MindTools.com to help team members set Specific, Measurable, Achievable, Relevant, Time-bound goals.\n\n📝 **Completion Requirement:** Set SMART goals with 5 team members, documenting progress and tracking progress.',
        'https://www.mindtools.com/a4wo118/smart-goals/'),
      L(5, 'Activity', 'Ask Powerful Questions That Promote Self-Discovery',
        '2 weeks of practice + 30 minutes documentation',
        'Practice asking open-ended questions that help team members discover solutions themselves rather than telling them. Watch active listening skills from TED-Ed.\n\n📝 **Completion Requirement:** Document 10 coaching conversations using powerful questions, including the questions you asked and insights team members discovered.',
        'https://www.youtube.com/results?search_query=active+listening+skills+ted+ed'),
      L(6, 'Activity', 'Develop Coaching Plans for Different Personality Types',
        '1.5 hours',
        "Use the free personality assessment from 16Personalities.com to understand your team members' personalities and adapt your coaching approach accordingly.\n\n📝 **Completion Requirement:** Create coaching plans for 4 different personality types, showing how you'll adapt your approach for each.",
        'https://www.16personalities.com/'),
      L(7, 'Reading', 'The Coaching Habit - Core Coaching Skills',
        '45 minutes reading + 15 minutes reflection',
        'Read "The Coaching Habit" by Michael Bungay Stanier (free summary on Blinkist trial). Focus on the seven essential coaching questions and how to shift from advice-giving to question-asking leadership.\n\n📝 **Completion Requirement:** Document how you can apply the seven coaching questions in your restaurant leadership role and identify 3 coaching opportunities for your team.',
        'https://www.blinkist.com/en/books/the-coaching-habit-en'),
      L(8, 'Reading', 'Radical Candor - Performance Management Principles',
        '40 minutes video + 20 minutes reflection',
        'Study "Radical Candor" by Kim Scott (free summary on YouTube). Focus on how to care personally and challenge directly, and the difference between ruinous empathy and radical candor.\n\n📝 **Completion Requirement:** Apply radical candor principles in your restaurant role and identify 3 situations where you need to challenge more directly.',
        'https://www.youtube.com/results?search_query=radical+candor+kim+scott+summary'),
      L(9, 'Activity', 'Provide Stretch Assignments for Growth',
        '2 weeks of implementation + 30 minutes documentation',
        'Give high-potential team members challenging assignments that stretch their capabilities and build new skills.\n\n📝 **Completion Requirement:** Assign 3 stretch assignments to different team members, documenting the assignment, outcomes, and support provided.'),
      L(10, 'Activity', 'Implement Succession Planning for Key Positions',
        '2 hours',
        'Use the free succession planning guide from SHRM.org to identify potential successors for key positions and create development paths for them.\n\n📝 **Completion Requirement:** Create a succession plan for 3 key positions, identifying potential successors for each and their development needs.',
        'https://www.shrm.org/resourcesandtools/tools-and-samples/toolkits/pages/successionplanning.aspx'),
      L(11, 'Activity', 'Recognize and Reward High Performance',
        '2 weeks of practice + 20 minutes documentation',
        'Implement systematic recognition and reward practices for high-performing team members. Document the impact of different recognition methods.\n\n📝 **Completion Requirement:** Document 10 instances of high performance recognized and method used.'),
      L(12, 'Activity', 'Track and Measure Development Progress',
        '1 hour setup + 4 weeks tracking',
        'Use the free progress tracking spreadsheet from Google Sheets to systematically track development progress and adjust plans as needed.\n\n📝 **Completion Requirement:** Set up tracking for 5 team members, including adjustments made based on progress.',
        'https://docs.google.com/spreadsheets/u/0/?ftv=1&folder=0AKrj_g6DBCGdUk9PVA'),
      L(13, 'Activity', 'Create Performance Improvement Plans When Needed',
        '1.5 hours',
        'Use the free performance improvement plan template from HR.com to create structured plans for team members who need additional support.\n\n📝 **Completion Requirement:** Create 1 performance improvement plan, documenting the support provided, and success metrics.',
        'https://www.hr.com/en/resources/free_forms_tools/performance_improvement_plan_template_71018.html'),
      L(14, 'Reading', 'Multipliers - Developing High-Potential Team Members',
        '1 hour reading + 20 minutes reflection',
        'Read "Multipliers" by Liz Wiseman (available free at local library). Focus on how to be a leader who makes everyone smarter and brings out the best in team members rather than being a diminisher.\n\n📝 **Completion Requirement:** Self-assess yourself as a leader and identify 3 team members whose potential you can better develop.',
